<script>
  ...
  import { fetchProjectGSCDimensions } from '../lib/data.js';
  ...
  $: if (projectId && gscStatus?.integration?.property_url && !loading && !pageRows.length) {
    loadData();
  }
...
<div class="space-y-6">
  <!-- Header -->
  <div>
    <h2 class="text-2xl font-bold mb-2">Keywords Per Page</h2>
