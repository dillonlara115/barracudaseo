...
- **WHAT**: A web-based crawler and decision engine that prioritizes fixes and explains the _rationale_ behind them.
...
- **Human**: We speak to the _person_ doing the job, not just the algorithm.
